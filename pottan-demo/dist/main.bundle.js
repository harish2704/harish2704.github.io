...
var ndarrayOps = __webpack_require__(6);
__webpack_require__(11);
var glyphsList = __webpack_require__(12);
glyphsList.unshift('');
var $ = jquery;
var range = function range(a) {
  return Array.from(new Uint32Array(a)).map(function (v, i) {
    return i;
  });
};
var IMG_WIDTH = 1024;
...
$(function () {
  ...
  $('#run-btn').click(function () {
    ...
    var data = ndarray(Float32Array.from(imageDataScaled.data), [imageDataScaled.height, imageDataScaled.width, 4]);
    ...
    model.predict({ input: input.data }).then(function (outputData) {
      ...
      var predictions = range(nPredictions).map(function (i) {
        return ndarrayOps.argmax(outputData.pick(i, null))[0];
      });
